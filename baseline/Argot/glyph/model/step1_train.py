...
if __name__ == "__main__":
    ...
    #       在终端中输入    CUDA_VISIBLE_DEVICES=0,1 python step1_train.py
    #   DDP模式：
    #       设置            distributed = True
    #       在终端中输入    CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 step1_train.py
    #---------------------------------------------------------------------#
    distributed     = False
    #---------------------------------------------------------------------#
    ...
    #   数据集存放的路径
    #----------------------------------------------------#
    dataset_path    = "/media/usr/external/home/usr/project/project2_data/baseline/Argot/datasets"
    #----------------------------------------------------#
    ...
    #------------------------------------------------------------------#
    save_dir            = '/media/usr/external/home/usr/project/project2_data/baseline/Argot/logs'
    #------------------------------------------------------------------#
