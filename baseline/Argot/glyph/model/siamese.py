...
from baseline.Argot.glyph.model.nets.siamese import Siamese as siamese
from baseline.Argot.glyph.model.utils.utils import letterbox_image, preprocess_input, cvtColor, show_config
...
class Siamese(object):
    _defaults = {
        ...
        #-----------------------------------------------------#
        "model_path"        : '/media/usr/external/home/usr/project/project2_data/baseline/Argot/logs/best_epoch_weights.pth',
        #-----------------------------------------------------#
        #   输入图片的大小。
        #-----------------------------------------------------#
        "input_shape"       : [105, 105],
