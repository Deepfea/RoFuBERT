...
all_labels = ['家居', '股票', '娱乐', '游戏', '社会', '科技', '时政', '体育', '教育', '财经']
dataset_path1 = '/media/usr/external/home/usr/project/project2_data/dataset/THUCNews'
...
print(time3)
# 加载最优权重对测试集测试
# model.load_state_dict(torch.load("BestBERTModel.pth"))
# model.load_state_dict(torch.load("best_bert_model.pth"))
# pred_test, pred_frac = evaluate(model, test_loader, DEVICE)
# print("\n Test Accuracy = {} \n".format(accuracy_score(y_test, pred_test)))
# print(classification_report(y_test, pred_test, digits=4))
# finall = pd.DataFrame({'pred_test': pred_test, 'pred_frac': pred_frac, 'y_test': y_test})
# finall.to_csv('class_2_experiment.csv', index=0)
