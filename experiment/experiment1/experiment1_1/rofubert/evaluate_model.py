...
def get_adv_data(model_name, dataset_name, load_path, save_path):
    ...
    load_data_path = os.path.join(load_path, str(important_num), model_name, dataset_name, 'step1_final_mutants.csv')
    ...
    adv_data = pd.concat([adv_data2, adv_data1], ignore_index=True)
