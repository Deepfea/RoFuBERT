...
def cal_deepGini(dataset_name, model_name, dataset_path, load_step_path, save_step_path, counter):
    ...
    for num in range(len(output_list)):
        ...
        ori_num_list.append(num)
    test_data['DeepGini_scores'] = DeepGini_scores
    test_data['counter'] = counter_list
    test_data['origin'] = ori_num_list
    # print(len(DeepGini_scores))
